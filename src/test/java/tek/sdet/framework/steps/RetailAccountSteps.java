...
import tek.sdet.framework.utilities.GenerateData;
...
public class RetailAccountSteps extends CommonUtility {
    ...
    public void userUpdateNameAndPhoneValues(String name, String phone) {
        ...
        sendText(factory.getAccountPage().nameInput, GenerateData.getData(name));
        ...
        sendText(factory.getAccountPage().personalPhoneInput, GenerateData.getData(phone));
    ...
    public void userFillDebitOrCreditCard(DataTable dataTable) {
        ...
        sendText(factory.getAccountPage().cardNumber,
                GenerateData.getData(map.get(0).get("cardNumber")));
        sendText(factory.getAccountPage().nameOnCard,
                GenerateData.getData(map.get(0).get("nameOnCard")));
        sendText(factory.getAccountPage().expirationMonth,
                GenerateData.getData(map.get(0).get("expirationMonth")));
        sendText(factory.getAccountPage().expirationYear,
                GenerateData.getData(map.get(0).get("expirationYear")));
        sendText(factory.getAccountPage().ccvCode,
                GenerateData.getData(map.get(0).get("securityCode")));
